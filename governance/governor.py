...
if __name__ == "__main__":
    ...
    parser.add_argument("--approve", type=str, help="Approve a plan by ID")
    parser.add_argument("--reject", type=str, help="Reject a plan by ID")
    ...
    parser.add_argument("--rollback", type=str, help="Rollback a patch by Plan ID")
